...
<head>
    ...
    <title>Admin Registration Invite - {{ config('app.name') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Admin Registration Invitation</h1>
        </div>

        <div class="content">
            <p>Hello,</p>

            <p>You have been invited to join <strong>{{ config('app.name') }}</strong> as an administrator. This invitation grants you access to the admin dashboard and management tools.</p>
        ...
        <div class="footer">
            <p>This email was sent to you because you were invited to join {{ config('app.name') }} as an administrator.</p>
